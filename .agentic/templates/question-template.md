...
**Fabric Graph supports grouped aggregation with `GROUP BY`.**
Use `LET` aliases when helpful for readability and reuse.
...
LET groupCol1 = a.Property1
LET groupCol2 = b.Property2
RETURN groupCol1,
       groupCol2,
...
```gql
-- Use ZONED_DATETIME() for zoned datetime literals
MATCH (n:Entity)
...
- `datetime()` for zoned datetime literals - use `ZONED_DATETIME()`
